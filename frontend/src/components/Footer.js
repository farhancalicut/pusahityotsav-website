    ...
    >
      <Container maxWidth="lg">
        ...
        <Grid container spacing={4} alignItems="center" justifyContent="space-between">
          ...
          >
            <Box>
              <IconButton href="https://www.instagram.com/ssfpondicherryuniversity?utm_source=ig_web_button_share_sheet&igsh=MXZ3dHBpZjI3NHZnZQ==" target="_blank" sx={{ color: 'white' }}>
                <InstagramIcon />
              </IconButton>
              <IconButton href="https://www.facebook.com/SSFPondicherryUniversity" target="_blank" sx={{ color: 'white' }}>
                <FacebookIcon />
              </IconButton>
            ...
            <Typography variant="body2" sx={{ color: '#bdbdbd', mt: 0 ,pl: { xs: 1, md: 1 },}}>
                © 2025 SSF PU
            </Typography>
          </Grid>
