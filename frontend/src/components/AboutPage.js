    ...
    <Container maxWidth="xl" sx={{ py: 6, px: { xs: 4, sm: 8, md: 10 } }}>
      ...
      >
        ...
        <Box>
          ...
          <Typography variant="body1" sx={{ fontSize: '1.0rem', lineHeight: 1.4 }}>
            Incepted 32 years ago in 1993, it has its commencement from the grassroot level - that is a family Sahityotsav. Crossing the levels of units, sectors, divisions, districts and 26 states in the country, it finds its actualization in the national level each year.
