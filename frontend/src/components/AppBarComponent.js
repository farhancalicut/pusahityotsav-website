...
>
  <img src="/images/logo.png" alt="University Logo" style={{ height: 30, marginLeft: 16 }} />
      ...
      >
        <AppBar sx={{ position: 'relative', backgroundColor: 'white', color: '#424242' }}>
          <Toolbar>
            <Typography variant="h6" sx={{ ml: 2, flex: 1, fontWeight: 'bold' }}>
              Menu
            </Typography>
